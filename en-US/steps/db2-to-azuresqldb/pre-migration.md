...
2. **Assess the source database** and discover conversion rate and effort to resolve issues.
   ...
   ![New Project](https://mpbdevcontent.azureedge.net/Images/scenario-assets/db2-to-azuresqldb/ssmadb2newproject.png)

   d. Connect to the DB2 server by providing the connection details in the "Connect to DB2" dialog.
   
   ![Connect to DB2](https://mpbdevcontent.azureedge.net/Images/scenario-assets/db2-to-azuresqldb/ssmadb2connect.png)
